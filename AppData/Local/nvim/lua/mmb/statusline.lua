...
---
---@return string
function M.section_fileinfo()
  local filetype = vim.bo.filetype
  if filetype == "" then
    return ""
  end

  local encoding = string.format("%s%s", vim.bo.fileencoding or vim.bo.encoding, vim.bo.bomb and "-BOM" or "")
...
-- => Highlight groups
---------------------------------------------------------------
vim.api.nvim_set_hl(0, "MmbStatuslineModeNormal", { bg = "NvimDarkGray4", fg = "NvimLightGray1" })
vim.api.nvim_set_hl(0, "MmbStatuslineModeInsert", { bg = "NvimLightGreen", fg = "NvimDarkGray1" })
vim.api.nvim_set_hl(0, "MmbStatuslineModeVisual", { bg = "NvimLightRed", fg = "NvimDarkGray1" })
vim.api.nvim_set_hl(0, "MmbStatuslineModeReplace", { bg = "NvimLightYellow", fg = "NvimDarkGray1" })
vim.api.nvim_set_hl(0, "MmbStatuslineModeCommand", { bg = "NvimLightBlue", fg = "NvimDarkGray1" })
vim.api.nvim_set_hl(0, "MmbStatuslineModeOther", { bg = "NvimLightMagenta", fg = "NvimDarkGray1" })
